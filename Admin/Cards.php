...
<body>
    ...
    <form class="" action="../data/dCards.php" method="post" autocomplete="off" enctype="multipart/form-data">
        ...
        <textarea type="text" name="img_desc" id="des" required value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-90 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea> <br>
    ...
    <?php foreach ($result as $row) : ?>
        ...
        <div class="inline-block items-center">
            ...
            <a href="Editcards.php?card_id=<?= $row['card_id'] ?>" type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2">Edit</a>

            <a href="../data/dCards.php?card_id=<?= $row['card_id'] ?>" type="button" class="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2  ml-10">Delete</a>
