            ...
            <div class="cart-items">
                <ul style="display: flex; flex-direction: row; justify-content: space-between;  align-items: center; padding: 30px">
                    ...
                    <li style="margin: 20px;">
                        ...
                        <form id="checkoutForm" onsubmit="return onSubmission(this)" method="post" action="marked-items-checkout.php?user_id=<?php echo $_SESSION['user_id']; ?>">
                            ...
                            <!-- <input type="checkbox" class="item-checkbox" name="item_checkboxes[]" value="<?= $row['item_id']; ?>" data-initial="<?= $totalInitial ?>" data-item-id="<?= $row['item_id']; ?>" data-user_id="<?= $row['user_id']; ?>" data-s_price="<?= $row['i_price']; ?>"> -->
                    ...
                    <li style="align-items: center; text-align: center">
                        <h4 class="font-semibold"><?= $row['i_name'] ?></h4>
                        <h4 class="text-green-600 text-xs">Available: <?= $row['i_quantity'] ?></h4>
                    </li>
                    <li style="align-items: center; text-align: center">
                        <h4 class=" text-red-600 font-semibold">Price: <?= number_format($row['i_price']) ?></h4>
                    </li>
                    <li style="align-items: center; text-align: center">
                        <h4 class=" text-orange-600 text-m font-semibold cursor-pointer delete--item" data-item--id="<?= $row['i_id'] ?>" data-user--id="<?= $row['user_id'] ?>">Delete</h4>
                    </li>
                    <li>
        ...
        <div class="total-payment">
            <ul class=" m-4 h-auto">
                <li style="margin-bottom: 2rem ;">
                    <h4 class=" bg-blue-200 p-3 text-slate-800 font-semibold" style="border-left: 6px solid blue; padding-left: 5px;">Items Summary</h4>
                </li>
                ...
                <li id="dateOptionChange">
                    ...
                    <select id="options" name="dateOptions" onchange="changeInputs()" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                ...
                <li>
                    ...
                    <div class="relative max-w-sm" id="singleDate">
                        ...
                        <input name="regular_date" id="singleDateInput" datepicker type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full ps-10 p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  " placeholder="Select date">
                    </div>
                    ...
                    <div date-rangepicker class="flex items-center " id="twoDates">
                        <div class="relative">
                            ...
                            <!-- start date -->
                            <input id="startDate" name="start" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select start">
                        </div>
