...
<div class="placed-item-container">
    ...
    <div class="payments-section rounded">
        ...
        <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <ul role="list" class="space-y-5 my-7">
                ...
                <ul id="initialItems">
                    <?php for ($i = 0; $i < count($checkboxValues); $i++) : ?>
                        <?php if ($i < 2) : ?>
                            ...
                            <li class="flex items-center flex-row justify-between">
                                <div>
                                    <span class="text-xs font-medium leading-tight text-black-500 dark:text-gray-400 ms-3 get_primary_info" data-get_id="<?php echo $itemIds[$i]; ?>" data-get_quantity="<?php echo $quantities[$i]; ?>" data-get_user_id="<?php echo $userIds[$i]; ?>" data-get_item_price="<?php echo $prices[$i] ?>">
                                        <?php echo $names[$i]; ?>
                                    </span>
                                </div>
                                <div>
                ...
                <ul id="remainingItems" style="display: none; margin-top: 0px;">
                    <?php for ($i = 2; $i < count($checkboxValues); $i++) : ?>
                        <li class="flex items-center flex-row justify-between">
                            <div>
                                <span class="text-xs font-medium leading-tight text-black-500 dark:text-gray-400 ms-3 get_primary_info" data-get_id="<?php echo $itemIds[$i]; ?>" data-get_quantity="<?php echo $quantities[$i]; ?>" data-get_user_id="<?php echo $userIds[$i]; ?>" data-get_item_price="<?php echo $prices[$i] ?>"><?php echo $names[$i]; ?></span>
                            </div>
                            <div>
                                <span class="text-xs font-medium leading-tight text-red-500 dark:text-red-400 ms-3"><?php echo number_format($prices[$i]) ?></span>
                            </div>
            ...
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center" id="placedBooking">Placed Booking</button>
        </div>
    </div>
