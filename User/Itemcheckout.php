...
<body>
    <div class="containerdiv">
        <div class="image-inline">
            <img class="" height="598" width="398" src="../Admin/Rooms/<?php echo $row["i_img"]; ?>" alt="...">
            <br>
        </div>

        <div class="description">

            <div class="custom-div w-full max-w-sm p-4">


                <form name="form" onsubmit="return validateFrom()" class="space-y-6" action="Place.php" method="post">
                    ...
                    <h5 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo $row["i_name"]; ?><br>₱. <?php echo number_format($row["i_price"]); ?></h5>
                    ...
                    <!-- meal -->
                    <label for="" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an meal</label>
                    ...
                    <!-- payment -->
                    <label for="" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an payment</label>
                    ...
                    <!-- submit -->
                    <button id="submit" type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="checkout">Check out</button>
                </form>
            </div>
        </div>
