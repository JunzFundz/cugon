...
<div id="login-body" class="container flex flex-row bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 z-50">
    ...
    <div class="login p-4 ">
        ...
        <form id="loginForm" onsubmit="return validateLogin(this)" class="space-y-6">
            ...
            <div>
                ...
                <a href="<?php echo $gclient->createAuthUrl(); ?>">
                    <button type="button" class="btn-login-google text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
