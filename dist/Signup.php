...
<body>
    <div id="signup-form" class="flex justify-center items-center">
        ...
        <div id="signup-body" class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-800 ">
            ...
            <form class="space-y-6" id="signupForm" onsubmit="return validateSignup(this)" action="../data/signup.php" method="post">
                <h5 class="text-xl text-center font-bold text-gray-900 dark:text-white">Sign up</h5>
                <!-- Username -->
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input name="username" id="username" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="phone" name="phone" id="phone" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="+639" />
                    </div>
                </div>

                <!-- Password -->
                <div>
                    <label for="phone-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password:</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                ...
                <button id="google-login-btn" type="button" class="btn-login-google text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
...
<script>
    document.getElementById('google-login-btn').addEventListener('click', function() {
        window.location.href = '<?php echo $gclient->createAuthUrl(); ?>';
    });
</script>